...
/**
 * Compact memory-only pill for mobile home page header.
 * Shows just memory usage with severity color.
 * Tapping opens the same full dropdown as McpStatusBar.
 */
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && typeof document !== 'undefined' && createPortal(
        <div
          className="fixed z-[99999] bg-gray-900 border-2 rounded-lg p-3 min-w-[260px] max-w-[calc(100vw-16px)]"
          style={{
            top: dropdownPos.top,
