/**
 * list_sessions tool — List all active Homestead sessions with metadata.
 *
 * Pulls from the Homestead sessions API for rich info (project name,
 * branch, path, worktree status) so agents can reason about targets.
 */
